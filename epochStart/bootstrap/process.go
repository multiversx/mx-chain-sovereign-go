...
func (e *epochStartBootstrap) isStartInEpochZero() bool {
	startTime := runType.UnixToTime(e.genesisNodesConfig.GetStartTime())
...
func (e *epochStartBootstrap) prepareComponentsToSyncFromNetwork() error {
	...
	/// THIS IS FROM ORIGINAL BARNARD CODE< MISSING INIT PARAMS FOR PROOFS AND ENABLE EPOCHS
...
// TODO: MARIUS C
// FROM ORIGINAL CODE<<<< CHECK syncHeadersFrom
...
// TODO: MARIUS C ALSO THESE FUNCS HAVE BEEN CHANGED
